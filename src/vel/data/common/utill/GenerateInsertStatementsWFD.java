...
public class GenerateInsertStatementsWFD {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	String wfd="CLAIMHBAADVANCEWFD";
    	
    	String[] tableNameArray={"AUGMS_WFD","AUGRL_WFD_FSMI","AUGRL_WFD_FSMII"};
    	String[] conditionArray={" where WFDID='"+wfd+"'"," where WFDID='"+wfd+"'"," where WFDID='"+wfd+"'"};
