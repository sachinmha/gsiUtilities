...
public class GenerateInsertStatementsMenu {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	String menuId="CLAIMHBAADVANCE";
    	
    	String[] tableNameArray={"AUGMS_MENUITEMS","AUGRL_MENUITEM_SECURITY"};
    	String[] conditionArray={" where MENUITEMID='"+menuId+"' or PARENTITEMID='"+menuId+"'",
    			" where MENUITEMID in (SELECT MENUITEMID FROM AUGMS_MENUITEMS where MENUITEMID='"+menuId+"' or PARENTITEMID='"+menuId+"')"};
